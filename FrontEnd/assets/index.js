...
function filterWorks(categoryId) {
    ...
    document.querySelector(`button[data-filter='${categoryId}']`).classList.add('filter-active');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (localStorage.getItem('token') != null && localStorage.getItem('userId') != null) {
        ...
        document.getElementById('space-introduction-in-mode-admin').style.marginTop = "-50px";
    }
